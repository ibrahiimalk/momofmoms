...
const PAGES: { id: string; title: string; emoji: string; rows: { key: string; label: string }[] }[] = [
  ...
  },
  {
    ...
    rows: [
      ...
      { key: 'book.date', label: 'Date field label' },
      { key: 'book.time', label: 'Time field label' },
      { key: 'book.notes', label: 'Notes field label' },
      { key: 'book.submit', label: 'Submit button' },
      { key: 'book.success', label: 'Success message' },
      { key: 'book.bookAnother', label: 'Book another link' },
